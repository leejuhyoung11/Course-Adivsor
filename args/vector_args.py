...
def get_path_args():
    parser = argparse.ArgumentParser(description="JSON file to Chroma Vectorstore")
    parser.add_argument("--json_vector_path", type=str, default="../vectorstore/course_schedule")
    parser.add_argument("--pdf_vector_path", type=str, default="../vectorstore/catalog")
